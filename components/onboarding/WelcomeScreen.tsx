...
export const WelcomeScreen = ({onStart}: welcomeScreenProps) => {
    ...
    return <div className=" flex flex-col gap-50 items-center max-w-2xl w-full">
        ...
        <div className="text-white flex gap-10 flex-col items-center w-full">
          ...
          <div className="flex justify-center gap-4 w-full max-w-md flex-col">
            <button disabled={!acceptedTerms} onClick={onStart} className="w-full disabled:bg-[#868789] disabled:text-[#111217] cursor-pointer font-semibold bg-white hover:bg-gray-200 rounded-md py-3 text-black">Create a new wallet</button>
